	...
	vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"param_name" => "layout",
				"value" => array(__("Item width 285px", 'medicenter') => "gallery-4-columns", __("Item width 600px", 'medicenter') => "gallery-2-columns", __("Item width 390px", 'medicenter') => "gallery-3-columns")
			),
			array(
				"type" => "dropdown",
				"class" => "",
