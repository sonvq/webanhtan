...
function theme_inner_doctors_custom_box_main($post)
{
	...
	<table>
		...
		<tr>
			<td>
				<label for="doctor_description">' . __('Description', 'medicenter') . ':</label>
			</td>
			<td>';
		...
		<tr>
			...
			<td>
				...
				<span class="description">' . __('For Vimeo please use https://vimeo.com/%video_id% For YouTube: https://www.youtube.com/watch?v=%video_id%', 'medicenter') . '</span>
			</td>
		</tr>
		<tr>
			<td>
	...
	vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"param_name" => "layout",
				"value" => array(__("4 columns", 'medicenter') => "gallery-4-columns", __("2 columns", 'medicenter') => "gallery-2-columns", __("3 columns", 'medicenter') => "gallery-3-columns")
			),
			array(
				"type" => "dropdown",
				"class" => "",
